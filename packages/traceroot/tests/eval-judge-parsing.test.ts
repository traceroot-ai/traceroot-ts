// Phase 5: llmJudge score parsing is an unambiguous exact-value parser, not "first number
...
describe('llmJudge score parsing', () => {
  ...
  it('does not turn "Step 3: the score is 0.8" into 3', async () => {
    await assert.rejects(() => judgeReturning('Step 3: the score is 0.8')(ctx) as any, /single numeric score/);
  });
